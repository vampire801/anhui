...
local function MahjongCommonMethodHotfix(self)
	print("--------MahjongCommonMethodHotfix.lua----------")
end
...
--xlua.hotfix(MahjongCommonMethod,"TestHotfix",MahjongCommonMethodHotfix)
end

local function Unregister()
--	xlua.hotfix(AssetbundleUpdater, "TestHotfix", nil)
--	xlua.hotfix(AssetBundleManager, "TestHotfix", nil)
--xlua.hotfix(MahjongCommonMethod, "TestHotfix", nil)
end
