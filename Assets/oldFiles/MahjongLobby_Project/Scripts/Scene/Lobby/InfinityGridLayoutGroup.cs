...
public class InfinityGridLayoutGroup : MonoBehaviour
{
    ...
    public void Init(int index = -1)
    {
        ...
        realIndex = index;
        realIndexUp = -1;
        gridLayoutSize = Vector2.zero;
        gridLayoutPos = Vector2.zero;
    ...
    IEnumerator InitChildren()
    {
        ...
        //Debug.LogError("hasInit:" + hasInit);
        ...
        {
            //  Debug.LogError("ceshi2222222222222222222222222222222222");
    ...
    /// 移除监听
    /// </summary>
    public void RemoveListener_Rect()
    {
        if (scrollRect != null)
        {
