...
namespace MahjongGame_AH.UISystem
{
    [Hotfix]
    [LuaCallCSharp]
    public class UIConstant 
    {
        ...
        public const ushort UIID_MAHJONG_GAME_GENERAL_MESSAGE = 0x1002; //消息面板
        public const ushort UIID_GENERAL_WAITING = 0x1003; //等待面板

        // 游戏的UI
        public const ushort UIID_MAHJONG_GAME_MAIN_PANEL = 0x1012; //主面板
        ...
        public static string UIIdToString(ushort id)
        {
            switch (id)
            {
                ...
                case UIConstant.UIID_MAHJONG_GAME_GENERAL_MESSAGE:
                ...
                // 游戏的UI
                case UIConstant.UIID_MAHJONG_GAME_MAIN_PANEL:
