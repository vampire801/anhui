    ...
    public class ChannelManager : Singleton<ChannelManager>
    {
        ...
        public BaseChannel CreateChannel(string packageName)
        {
            ...
            switch ((platName))
            {
                ...
                case ChannelType.TestA1:
                    return new TestA1Channel();
                case ChannelType.TestA2:
                    return new TestA2Channel();
                case ChannelType.TestA3:
                    return new TestA3Channel();
                case ChannelType.TestI1:
                    return new TestI1Channel();
                case ChannelType.TestI2:
                    return new TestI2Channel();
                case ChannelType.TestI3:
                    return new TestI3Channel();
                default:
                    return new TestChannel();
            }
        }
