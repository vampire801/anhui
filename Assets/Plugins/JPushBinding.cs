...
namespace JPush
{
    public class JPushBinding : MonoBehaviour
    {
        ...
        static JPushBinding()
        {
            ...
            using (AndroidJavaClass jpushClass = new AndroidJavaClass("com.ibluejoy.anhuishuangxi.jpush.JPushBridge"))
            {
...
#if UNITY_ANDROID
            // Debug.LogError("获取当前设备的 Registration Id："+  _plugin.Call<string>("getRegistrationId"));
