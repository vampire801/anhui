...
// No parameters
public static class Messenger_anhui
{
...
// One parameter
public static class Messenger_anhui<T>
{
	private static Dictionary<string, Delegate> eventTable = MessengerInternal.eventTable;
...
// Two parameters
public static class Messenger_anhui<T, U>
{
	private static Dictionary<string, Delegate> eventTable = MessengerInternal.eventTable;
...
// Three parameters
public static class Messenger_anhui<T, U, V>
{
	private static Dictionary<string, Delegate> eventTable = MessengerInternal.eventTable;
